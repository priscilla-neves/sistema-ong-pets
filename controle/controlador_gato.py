...
class ControladorGato():
  ...
  def incluir_animal(self):
    ...
    animal = Gato(dados_animal["nome"], dados_animal["raca"], dados_animal["chip"])
  ...
  def alterar_animal(self): 
    ...
    if(animal is not None):
      ...
      self.__tela_animal.mostra_mensagem("ATENCAO: Gato não existente")

  # Sugestão: se a lista estiver vazia, mostrar a mensagem de lista vazia
  def lista_animais(self):
    for animal in self.__animais:
      self.__tela_animal.mostra_animal({"nome": animal.nome, "raca": animal.raca, "chip": animal.chip})
  ...
  def excluir_animal(self):
    ...
    if(animal is not None):
      ...
      self.lista_animais()
      self.__tela_animal.mostra_mensagem("Gato excluído")
    else:
      self.__tela_animal.mostra_mensagem("ATENCAO: Gato não existente")
  ...
  def verifica_animal(self):
    ...
    animal = self.pega_animal_por_chip(chip_animal)
    if (animal == None):
      self.__tela_animal.mostra_mensagem("ATENCAO: Gato não existente, realize o cadastro.")
      self.abre_tela()
    else :
